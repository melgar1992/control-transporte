<div class="right_col" role="main">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Registro de Empleado <small>-</small></h2>
        ...
        <div class="x_content">
          <br />
          <form method="post" id="nuevo_empleado" data-parsley-validate class="form-horizontal form-label-left">
            <!--value="<?php //echo site_url('/form/conductor/ingresar_conductor') 
                        ?>" -->
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="number" id="CI" name="CI" required="required" class="form-control col-md-7 col-xs-12" placeholder="Número de Carnet de Identidad">
              </div>
            </div>
