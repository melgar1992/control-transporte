const   formularioNuevoContrato = document.querySelector('#nuevo_contrato');
        ...
        inputBuscarEmpleado = document.querySelector('#buscar-empleado');
        inputBuscarCI = document.querySelector('#buscar-ci');
...
function addEventListeners(){
    ...
    inputBuscarEmpleado.addEventListener('input',buscarEmpleados);

    inputBuscarCI.addEventListener('input',buscarCI);
...
function buscarEmpleados(e){
    const expresion = new RegExp(e.target.value,"i");
        registros = document.querySelectorAll('#datos-empleados tr');
...
function identificarAccion(e){
    ...
    else{if (e.target.getAttribute('data-acction')==='borrar') {
